...
| =trashstart_off= | uint16 | Intra-page row offset. See [[Trash Management]].                  |
| =trashvor=       | uint64 | Page id or -1, See [[Trash Management]].                          |
...
Page right will always be 0 (as of now, until I can find a reason to
make this a 2-way linked list). So you can only transverse forward.
