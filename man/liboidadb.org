...
structured data across multiple computers on a network. The magnituded
of such data can grow to be millions of terabytes, with every byte
accessible within nanoseconds.
...
* Index
 ...
 2. Errors - 50% of your job is handling errors; the other 50% is
    making them.
    1. =odb_errstr=
 ...
 7. [[./odbh.org][The OidaDB Handle]]
    ...
    1. [[./odbh_job.org][=odbh_job=]]
	2. [[./odbh_poll.org][=odbh_poll=]]
